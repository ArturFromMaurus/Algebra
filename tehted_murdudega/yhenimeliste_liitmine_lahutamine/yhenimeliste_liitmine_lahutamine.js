...
function draw() {
  ...
  } else if (    ( (str(lugeja_murrus_1).length==2 || str(nimetaja_murrus_1).length==2) && ( str(lugeja_murrus_2).length==1 && str(nimetaja_murrus_1).length==1 ) )  || ( (str(lugeja_murrus_2).length==2 || str(nimetaja_murrus_1).length==2) && ( str(lugeja_murrus_1).length==1 && str(nimetaja_murrus_1).length==1 ) )  ) {
  ...
  } else if ( (str(lugeja_murrus_1).length==2 && str(lugeja_murrus_2).length==2) || ( str(nimetaja_murrus_1).length==2) ){
...
function Ylesanne(){
  ...
  vastus_kontrollimiseks = (lugeja_murrus_1+mark_numbriline*lugeja_murrus_2)/(nimetaja_murrus_1);
  
  
  tex_string="\\dfrac{"+str(lugeja_murrus_1)+"}{"+str(nimetaja_murrus_1 )+"}"+str(margi_valik)+"\\dfrac{"+str(lugeja_murrus_2)+ "}{"+str(nimetaja_murrus_1)+"}= \\dfrac{ \\hspace{10mm}}{\\hspace{10mm}}";
