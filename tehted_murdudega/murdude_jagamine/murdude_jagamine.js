...
regularText.innerHTML = "Vastust võib sisestada nii taandatud kui ka taandamata kujul.<br><br>Näiteks.";
regularText.style.fontFamily="Computer Modern";
regularText.style.fontSize="20px";
tooltip.appendChild(regularText);

KaTeX_EQ="\\dfrac{4}{9} : \\dfrac{14}{30}=\\dfrac{4}{9} \\cdot \\dfrac{30}{14}=\\dfrac{4 \\cdot 30}{ 9 \\cdot 14}=\\dfrac{20}{21}."
...
function Ylesanne(){
  ...
  vastus_kontrollimiseks = (lugeja_murrus_1*nimetaja_murrus_2)/(lugeja_murrus_2*nimetaja_murrus_1)
  
  
  tex_string="\\dfrac{"+str(lugeja_murrus_1)+"}{"+str(nimetaja_murrus_1 )+"} : \\dfrac{"+str(lugeja_murrus_2)+ "}{"+str(nimetaja_murrus_2)+"}= \\dfrac{ \\hspace{10mm}}{\\hspace{10mm}}";
